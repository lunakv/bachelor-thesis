...
V~praktickém použití však SAT může narážet na své limitované vyjadřovací schopnosti. Práce s~booleovskými proměnnými, omezenými pouze na dvě různé hodnoty, může komplikovat převod reálného problému do tvaru booleovské formule. Potřeba užití komplexnějších atomů tak vedla ke zobecnění SAT zvanému \emph{Satisfiability modulo theories} (SMT).
