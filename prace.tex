...
\begin{itemize}
	\item adresář \icode{opensmt} --- úplný obsah repozitáře OpenSMT, respektive jeho větve určené této práci, k~25. 7. 2020
	\item soubor \icode{patch} --- patch oproti větvi master z~9.~12.~2019 obsahující všechny změny provedené v~této práci
