...
%Jak vidíme, OpenSMT se zařadilo do průměru soutěžících. Nemůže se sice zatím rovnat s nejlepšími řešiči Yices a z3, se všemi ostatními však má minimálně srovnatelné hodnocení. V porovnání s CVC4 jsme dosáhli $97\,\%$ vyřešených testů a byli jsme dokonce znatelně úspěšnější než veriT, SMTInterpol a MathSAT.
%Tyto výsledky považujeme za úspěch jak frameworku OpenSMT, tak naší implementace řešiče diferenční logiky.
